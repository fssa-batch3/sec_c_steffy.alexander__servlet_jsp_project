...
<body>
	...
	<div class="header">
		<a href="createplant.jsp" id="create_plant">Create a plant</a> <a
			...
			href="deleteplant.jsp">Delete a plant</a> <a href="./home.jsp">Home</a>
	</div>
			...
			<div class="full_form">
				<div class="card_details">
					<label for="name" class="form-label"> Name:</label> <input
						...
						placeholder="Enter plant name" pattern="^[A-Za-z\s\-']+$" required />

					<label for="image" class="form-label">Image url:</label> <input
						type="url" id="image" name="mainimage" class="form-control"
						placeholder="Enter image URL" required /> <label for="price"
				...
				<div class="details_page">
					<label for="image_1" class="form-label"> image_1:</label> <input
						type="text" id="image_1" name="image1" class="form-control"
						placeholder="Enter image_1 URL" required /> <label for="image_2"
						...
						placeholder="Enter plant height" required /> <label
						for="Planting_Season" class="form-label"> Planting Season:</label>
					<input type="text" id="Planting_Season" class="form-control"
						name="plantingSeason" placeholder="Enter planting season" required />

					<label for="hybridType" class="form-label">Hybrid:</label> <select
