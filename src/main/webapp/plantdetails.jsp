...
<body>
	...
	<div class="container">
			...
			<div class="box1">
				<div class="imgtrend" alt="hibiscusimg">
					...
					<div class="plantimages">
						<img id="hibiscus_1" src=<%=plant.getPlantImagesUrl().get(1)%>
							alt="hibiscus" /> <img src=<%=plant.getPlantImagesUrl().get(2)%>
							alt="flower"> <img
							src=<%=plant.getPlantImagesUrl().get(3)%> alt="flower">
		...
		<div class="right">
			<h2><%=plant.getPlantName()%>
			</h2>
 <span
				id="numinrs"> &#x20B9; <%=plant.getPrice()%>
			</span>
       ...
       -->
			...
			<h5>Highlights</h5>
			<ul>
				<li>Plant Name: <%=plant.getPlantName()%>
				</li>
				<li>Type: <%=plant.getPlantType()%>
				</li>
				<li>Height: <%=plant.getPlantHeight()%> feet
				</li>
			</ul>
			<table>
				<thead>
