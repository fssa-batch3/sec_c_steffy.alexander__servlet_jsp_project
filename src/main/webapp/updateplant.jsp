...
<body>
	...
	<div class="header">
		<a href="./CreatePlant" id="create_plant">Create a plant</a> <a
			...
			href="./DeletePlantDetails">Delete a plant</a> <a href="./home.jsp">Home</a>
	</div>
	...
	<div class="container">
		...
		<form id="update_form" action="./UpdatePlant" method="post">
			<div class="update_details">
				...
				<label for="image_2"> image_2:<input type="text"
				...
				</select> <br /> <label for="Height"> Height: <input type="number"
					...
					id="update_Planting_Season" pattern="[A-Za-z]+"
					name="plantingseason" />
				</label> <br> <label for="hybridType">Hybrid:</label> <select
					id="hybridType" value=<%=plant.getHybrid()%> name="planthybrid">
		...
		<a href="./UpdatePlant?plantname=<%=plantDetails.getPlantName()%>">
			...
			<div class="box1">
				<div class="imgtrend" alt="trend">
					<img 
						src="<%=plantDetails.getPlantImagesUrl().get(0)%>" alt="rose">
