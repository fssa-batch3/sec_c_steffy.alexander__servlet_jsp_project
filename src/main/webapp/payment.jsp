	...
	<div class="container">
		<div class="payment">
			...
			<a class="card pay click"> <img
				src="../../assests/images/card icon.png" alt="card" />
				<div class="card para">
					<h2>Card</h2>
			...
			<div class="card_details">
				<label for="number">Card number <input
					autocomplete="off" id="card_number"
					oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
					type="number" maxlength="16" minlength="16" inputmode="numerical"
				...
				<div class="div">
					...
					<div class="expiry_date">
						<input autocomplete="off" id="month"
							oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
							type="number" maxlength="2" minlength="2" inputmode="numerical"
							placeholder="MM" type="number" data-pattern-validate />

						<input autocomplete="off" id="year"
							oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
							type="number" maxlength="2" minlength="2" inputmode="numerical"
							placeholder="YY" type="number" data-pattern-validate />
					</div>

					<p>CVV</p>

					<div class="cvc">
						<input autocomplete="off" id="cvv"
							oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
							type="number" maxlength="3" inputmode="numerical"
							placeholder="123" type="number" data-pattern-validate />
					</div>
				</div>
				<button id="place_order_button">
					Pay ₹ <span class="rs"> 0 </span>
				</button>
			</div>
			...
			<div class="other_apps">
				...
				<div class="upi_trans">
					<div class="icons">
						<img id="gpay" src="../../assests/images/gpay_icon.png" alt="gpay" />
						<img id="paytm" src="../../assests/images/paytm_logo.png"
							alt="paytm" /> <img
							src="assets/images/phonepe.png" alt="phonepe" />
					</div>
					<label for="upi_id">Enter your UPI Id <input
						type="email" id="upi_id" placeholder="robert@oksbibank" /></label>
		...
		<div class="pro_details">
			...
			<div class="price">
				<p>
					Price ( <span id="num_items"> 1 </span> item)
				</p>
				<p>
